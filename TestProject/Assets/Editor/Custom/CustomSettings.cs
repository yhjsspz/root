...
{
    public static string saveDir = Application.dataPath + "/Extends/Plugins/ToLua/Source/Generate/";    
    public static string toluaBaseType = Application.dataPath + "/Extends/Plugins/ToLua/BaseType/";    
    ...
    {                
        ...
        _GT(typeof(DebugManager)),
        _GT(typeof(SceneManagerEx)),
        _GT(typeof(NetworkManager)),
        _GT(typeof(BaseView)),
        _GT(typeof(BaseWindow)),
        _GT(typeof(BaseScene)),
        ...
        _GT(typeof(CFramework.FileUtil)),
        ...
        _GT(typeof(DG.Tweening.Core.TweenerCore<Vector3, Vector3[], DG.Tweening.Plugins.Options.Vector3ArrayOptions>)),
        ...
        _GT(typeof(RawImage)).AddExtendType(typeof(DG.Tweening.ShortcutExtensions46)),
