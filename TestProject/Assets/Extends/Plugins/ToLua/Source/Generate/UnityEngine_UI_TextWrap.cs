...
public class UnityEngine_UI_TextWrap
{
	...
	static int DOBlendableColor(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.UI.Text, UnityEngine.Color, float>(L, 1))
			{
				UnityEngine.UI.Text obj = (UnityEngine.UI.Text)ToLua.ToObject(L, 1);
				UnityEngine.Color arg0 = ToLua.ToColor(L, 2);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 3);
	...
	static int DOFade(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.UI.Text, float, float>(L, 1))
			{
				UnityEngine.UI.Text obj = (UnityEngine.UI.Text)ToLua.ToObject(L, 1);
				float arg0 = (float)LuaDLL.lua_tonumber(L, 2);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 3);
