...
public class CFramework_ByteBufferWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(CFramework.ByteBuffer), typeof(System.Object));
		...
		L.RegFunction("New", _CreateCFramework_ByteBuffer);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.EndClass();
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateCFramework_ByteBuffer(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				CFramework.ByteBuffer obj = new CFramework.ByteBuffer();
			...
			else if (count == 1 && TypeChecker.CheckTypes<byte[]>(L, 1))
			{
				...
				CFramework.ByteBuffer obj = new CFramework.ByteBuffer(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: CFramework.ByteBuffer.New");
			}
		}
		catch (Exception e)
		{
