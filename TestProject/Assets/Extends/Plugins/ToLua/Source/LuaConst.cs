...
{
    public static string luaDir = Application.dataPath + "/GameApp/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/Extends/Plugins/ToLua/Lua";        //tolua lua文件目录
